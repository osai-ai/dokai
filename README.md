...
Pull an image
```Bash
docker pull ghcr.io/osai-ai/dokai:22.03-pytorch
```

Docker Hub [mirror](https://hub.docker.com/r/osaiai/dokai/tags)
```bash
docker pull osaiai/dokai:22.03-pytorch
```
...
<details><summary style="margin-left: 20px;">dokai:21.09-tensor-stream</summary>
<div style="margin-left: 20px;">
